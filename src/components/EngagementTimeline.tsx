...
export function EngagementTimeline() {
  ...
  return (
    <section className="pointer-events-auto absolute right-[28rem] bottom-44 z-10 flex h-44 w-[24rem] flex-col rounded-[2px] border border-[var(--color-line)] bg-[var(--color-canvas)]/92 backdrop-blur-sm">
