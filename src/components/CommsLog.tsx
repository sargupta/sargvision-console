...
export function CommsLog() {
  ...
  return (
    <section className="pointer-events-auto absolute bottom-0 left-72 right-[28rem] z-10 flex h-44 flex-col border-t border-[var(--color-line)] bg-[var(--color-canvas)]/92 backdrop-blur-sm">
